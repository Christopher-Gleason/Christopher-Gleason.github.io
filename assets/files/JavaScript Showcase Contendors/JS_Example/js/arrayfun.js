...
let numbersOriginal	= new Array(SIZE);			//	Original array
let numbersCopy	= new Array(SIZE);	
let choice		=   0;							//	Copy of numbersOriginal array
let sum			=   0;							//	Sum of  array values
let avg			= 0.0;	
...
{	//	Begin function createNewArray()
		...
		for (let lcv = 0; lcv < numbersOriginal.length; ++lcv)
		{
...
{	//	Begin function displayArray(numbersOriginal, "Original")
	let outputStr 	= "The array in " + theOrder + " order:\n";
	let end		= SIZE - 1;
	let lcv		= 0;
